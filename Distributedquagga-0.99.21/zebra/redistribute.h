...
extern void zebra_redistribute_add (int, struct zserv *, int, uint16_t);
extern void zebra_redistribute_delete (int, struct zserv *, int, uint16_t);

extern void zebra_redistribute_default_add (int, struct zserv *, int, uint16_t);
extern void zebra_redistribute_default_delete (int, struct zserv *, int, uint16_t);

extern void redistribute_add (struct prefix *, struct rib *, uint16_t);
extern void redistribute_delete (struct prefix *, struct rib *, uint16_t);
