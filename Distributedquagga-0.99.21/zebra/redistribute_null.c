...
void zebra_redistribute_add (int a, struct zserv *b, int c, uint16_t virtualNetworkNo)
{ return; }
...
void redistribute_add (struct prefix *a, struct rib *b, uint16_t virtualNetworkNo)
{ return; }
