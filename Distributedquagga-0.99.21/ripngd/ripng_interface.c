...
int
ripng_interface_up (int command, struct zclient *zclient, zebra_size_t length, uint16_t virtualNetworkNo)
{
  struct stream *s;
...
int
ripng_interface_add (int command, struct zclient *zclient, zebra_size_t length, uint16_t virtualNetworkNo)
{
  struct interface *ifp;
