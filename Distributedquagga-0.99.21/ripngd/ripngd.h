...
extern int ripng_interface_up (int command, struct zclient *, zebra_size_t, uint16_t virtualNetworkNo);
extern int ripng_interface_down (int command, struct zclient *, zebra_size_t, uint16_t virtualNetworkNo);
extern int ripng_interface_add (int command, struct zclient *, zebra_size_t, uint16_t virtualNetworkNo);
extern int ripng_interface_delete (int command, struct zclient *, zebra_size_t, uint16_t virtualNetworkNo);
