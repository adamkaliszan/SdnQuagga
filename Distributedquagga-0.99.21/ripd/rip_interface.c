...
int
rip_interface_down (int command, struct zclient *zclient, zebra_size_t length, uint16_t virtualNetworkNo)
{
  struct interface *ifp;
  struct stream *s;
...
int
rip_interface_up (int command, struct zclient *zclient, zebra_size_t length, uint16_t virtualNetworkNo)
{
  struct interface *ifp;
...
int
rip_interface_add (int command, struct zclient *zclient, zebra_size_t length, uint16_t virtualNetworkNo)
{
  struct interface *ifp;
