...
extern ssize_t stream_read_try_IPv6(int fd, struct in6_addr* src, struct in6_addr* dst, int* ifindex, unsigned int* virtualNetworkNo, struct iovec* message);
extern ssize_t stream_read_try_IPv4(int fd, struct in_addr* src, struct in_addr* dst, int* ifindex, unsigned int* virtualNetworkNo, struct iovec* message);
